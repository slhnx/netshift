...
var estreePlugin = createParsersAndPrinters([
  {
    importPlugin: () => import("./estree-DD7JJU56.js"),
...
var { parsers, printers } = createParsersAndPrinters([
  ...
  {
    importPlugin: () => import("./angular-UXQ47ZJV.js"),
    parsers: [
      "__ng_action",
      "__ng_binding",
      "__ng_interpolation",
  ...
  {
    importPlugin: () => import("./html-JQS5ACQW.js"),
  ...
  {
    importPlugin: () => import("./postcss-O3AUU5VG.js"),
...
var printJSON = (data) => {
  ...
  console.log(
    highlight2(prettyJSON, {
      language: "json",
      ignoreIllegals: true
    })
  );
};
var printResponse = async (data, dataType) => {
  if (dataType === "json") {
    printJSON(data);
    return;
  }
  if (dataType === "html") {
    ...
    const prettyHTML = await index_exports.format(String(data), { parser: "html" });
    console.log(
      highlight2(prettyHTML, {
        language: "html",
        ignoreIllegals: true
      })
    );
...
var normalizeUrl = (value) => {
  try {
    ...
    if (!url3.protocol || !url3.hostname) {
